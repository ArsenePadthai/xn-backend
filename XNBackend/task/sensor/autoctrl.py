...
from XNBackend.models.models import db, AutoControllers, Switches, Relay  
...
def auto_control():
    ...
    for control in AutoControllers.query.filter_by(if_auto=1).order_by():
        ir_query.apply_async(args = [control, True, is_day], queue = control.ir_sensor.tcp_config.ip+':'+str(control.ir_sensor.tcp_config.port))
